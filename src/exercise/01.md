...
- How to use the useReducer hook to provide state. The hook takes a reducer and an action as a value.
  The action is then passed to the reducer function as an argument
- How to merge a state object with a new action passed to the state
- How to use a dispatch function to change state with useReducer
